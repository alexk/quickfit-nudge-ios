...
struct Streak: Identifiable, Codable {
    ...
    enum StreakType: String, Codable, CaseIterable {
        ...
        case familyFriendly = "Family Activities"
        ...
        var description: String {
            ...
            case .familyFriendly: return "Do activities with your family"
...
struct Achievement: Identifiable, Codable {
    ...
    enum AchievementType: String, Codable, CaseIterable {
        ...
        var tier: Tier {
            ...
            case .centuryClub, .familyChampion, .socialButterfly: return .platinum
            }
        }
    }

...
final class WorkoutTests: XCTestCase {
    ...
    func testWorkoutInitialization() {
        ...
        XCTAssertFalse(workout.isFamilyFriendly)
    ...
    func testWorkoutTypeIconNames() {
        ...
        XCTAssertEqual(WorkoutType.familyFriendly.iconName, "figure.2.and.child.holdinghands")
    ...
    func testWorkoutTypeRecommendedDuration() {
        ...
        XCTAssertEqual(WorkoutType.familyFriendly.recommendedDuration, 5)
